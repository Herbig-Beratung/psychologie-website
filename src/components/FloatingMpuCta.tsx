    ...
    <div className="fixed right-5 sm:right-8 top-[32%] z-50 flex items-end gap-3">
      ...
      {!minimized && (
        <div className="relative bg-card border border-border rounded-2xl shadow-2xl p-3.5 sm:p-4 w-52 sm:w-56 animate-fade-in-up">
          ...
          <div className="absolute bottom-5 -right-[7px]">
      ...
      <button
        ...
        className={`relative w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden ring-3 ring-secondary shadow-lg shrink-0 transition-transform duration-200 ${
