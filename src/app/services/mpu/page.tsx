    ...
    <>
      ...
      <section className="relative py-12 sm:py-16 md:py-24 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-5 sm:px-6">
          <Link
            href="/services"
            className="inline-flex items-center text-white/60 hover:text-white text-sm mb-6 sm:mb-8 transition-colors"
          >
            <svg
          ...
          <p className="text-secondary font-semibold text-sm uppercase tracking-widest mb-3 sm:mb-4 animate-fade-in-up">
            Für Einzelpersonen
          </p>
          <h1 className="text-2xl sm:text-4xl md:text-5xl font-bold text-white mb-4 sm:mb-6 animate-fade-in-up-delay-1 leading-tight">
            Verkehrspsychologische Beratung &{" "}MPU-Vorbereitung
          </h1>
          <p className="text-sm sm:text-base md:text-lg text-white/70 max-w-2xl leading-relaxed animate-fade-in-up-delay-2">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 mt-6 sm:mt-8 animate-fade-in-up-delay-3">
            <Link
              href="/contact?subject=mpu"
              className="inline-flex items-center justify-center px-7 py-3.5 sm:py-3 bg-secondary text-white font-medium rounded-lg hover:bg-secondary/90 transition-colors duration-200 text-sm"
            >
              Kostenloses Erstgespräch vereinbaren
            </Link>
            <a
              href="tel:03098596064"
              className="inline-flex items-center justify-center sm:justify-start gap-2 text-white/70 hover:text-white transition-colors text-sm py-2"
            >
      ...
      {/* Kurzvorstellung */}
      <section className="py-10 sm:py-12 md:py-20 bg-card">
        <div className="max-w-6xl mx-auto px-5 sm:px-6">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 md:gap-12">
            <Image
              ...
              width={180}
              height={180}
              className="w-28 h-28 sm:w-36 sm:h-36 md:w-44 md:h-44 rounded-full object-cover object-top shrink-0"
            />
            <div className="text-center md:text-left">
              <p className="text-secondary font-semibold text-sm uppercase tracking-widest mb-2 sm:mb-3">
                Ihr Berater
              </p>
              ...
              <ul className="space-y-2 sm:space-y-3 text-left">
                {[
                  ...
                  <li key={i} className="flex items-start gap-2 sm:gap-3 text-sm sm:text-base text-muted">
      ...
      {/* Pakete & Preise */}
      <section className="py-10 sm:py-12 md:py-20 bg-gradient-to-br from-primary to-primary-dark text-white">
        <div className="max-w-5xl mx-auto px-5 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {/* Kompakt-Paket */}
            <div className="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-5 sm:p-8 flex flex-col">
              ...
              <p className="text-white/50 text-sm mb-5 sm:mb-6">
              ...
              <Link
                ...
                className="block w-full px-6 py-3.5 sm:py-3 border border-white/30 text-white font-medium rounded-lg hover:bg-white/10 transition-colors duration-200 text-sm text-center"
              >
            ...
            {/* Standard-Paket */}
            <div className="relative bg-white/15 backdrop-blur-sm border-2 border-secondary rounded-2xl p-5 sm:p-8 flex flex-col mt-2 md:mt-0">
              ...
              <Link
                href="/contact?subject=mpu"
                className="block w-full px-6 py-3.5 sm:py-3 bg-secondary text-white font-medium rounded-lg hover:bg-secondary/90 transition-colors duration-200 text-sm text-center"
              >
                Erstgespräch vereinbaren
              </Link>
            </div>
      ...
      <section className="py-10 sm:py-12 md:py-20 bg-background">
        <div className="max-w-6xl mx-auto px-5 sm:px-6">
          ...
          <div className="mt-10 sm:mt-12 pt-8 sm:pt-10 border-t border-border">
            <h3 className="font-semibold text-foreground text-base sm:text-lg mb-4 sm:mb-6">Rundum-Service inklusive</h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-x-8 gap-y-3 sm:gap-y-4">
              {[
      ...
      <section className="py-10 sm:py-12 md:py-20 bg-card">
        <div className="max-w-4xl mx-auto px-5 sm:px-6">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-foreground mb-8 sm:mb-10">
          ...
          <div className="relative">
            {[
              ...
              <div key={i} className="relative flex gap-4 sm:gap-6">
                ...
                <div className={`pb-6 sm:pb-10 ${i === arr.length - 1 ? "pb-0" : ""}`}>
      ...
      <section className="py-10 sm:py-12 md:py-20 bg-gradient-to-br from-primary to-primary-dark text-white">
        <div className="max-w-3xl mx-auto px-5 sm:px-6 text-center">
          ...
          <p className="text-white/80 text-sm sm:text-base md:text-lg leading-relaxed mb-5 sm:mb-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 text-sm text-white/60 mb-6 sm:mb-8 max-w-lg mx-auto">
            {[
          ...
          <Link
            href="/contact?subject=mpu"
            className="inline-flex items-center justify-center w-full sm:w-auto px-8 py-3.5 bg-secondary text-white font-medium rounded-lg hover:bg-secondary/90 transition-colors duration-200 text-base"
          >
            Kostenloses Erstgespräch vereinbaren
          </Link>
        </div>
